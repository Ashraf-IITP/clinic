...
import cc.altius.clinic.model.rowmapper.AppointmentRowMapper;
...
public class AppointmentDaoImpl implements AppointmentDao {
    ...
    private String appointmentString = "SELECT "
            + "    a.APPOINTMENT_ID, "
            + "    p.PATIENT_ID, p.PATIENT_NAME `PATIENT_NAME`, "
    ...
    public int addAppointment(Appointment apt) {
        SimpleJdbcInsert si = new SimpleJdbcInsert(dataSource).withTableName("ms_appointment").usingGeneratedKeyColumns("APPOINTMENT_ID");
        ...
        params.put("APPOINTMENT_STATUS_ID", 1); // Booked
    ...
    public int editAppointment(Appointment apt) {
        String sqlString = "UPDATE ms_appointment a SET a.START_TIME=:startTime, a.DOCTOR_ID=:doctorId, a.SCHEDULE_DATE=:scheduleDate, a.LAST_MODIFIED_DATE=:curDate, a.LAST_MODIFIED_BY=:curUser WHERE a.APPOINTMENT_ID=:appointmentId";
        Map<String, Object> params = new HashMap<>();
